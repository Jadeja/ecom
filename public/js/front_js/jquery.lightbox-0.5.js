        ...
        settings = jQuery.extend(
            {
                ...
                imageLoading:
                    "/images/front_images/lightbox/lightbox-ico-loading.gif", // (string) Path and the name of the loading icon
                imageBtnPrev:
                    "/images/front_images/lightbox/lightbox-btn-prev.gif", // (string) Path and the name of the prev button image
                imageBtnNext:
                    "/images/front_images/lightbox/lightbox-btn-next.gif", // (string) Path and the name of the next button image
                imageBtnClose:
                    "/images/front_images/lightbox/lightbox-btn-close.gif", // (string) Path and the name of the close btn
